...
var is_finite = __webpack_require__(40);
...
var integer_dataHandle = function dataHandle(event, inputEl, binding, vnode, options) {
  ...
  var maxFigures = !is_finite_default()(options.maxFigures) ? undefined : newValue < 0 ? options.maxFigures + 1 : options.maxFigures;
...
/* harmony default export */ var integer = ({
  ...
  bind: function bind(el, binding, vnode) {
    ...
    inputEl.keyupHandle = function (event) {
      event.isTrusted && integer_dataHandle(event, inputEl, binding, vnode, options);
    };
